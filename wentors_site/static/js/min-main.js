(function(){"use strict";const select=(el,all=!1)=>{el=el.trim()
    ...
    new Swiper('.clients-slider',{speed:400,loop:!0,autoplay:{delay:5000,disableOnInteraction:!1},slidesPerView:'auto',pagination:{el:'.swiper-pagination',type:'bullets',clickable:!0},breakpoints:{320:{slidesPerView:2,spaceBetween:40},480:{slidesPerView:3,spaceBetween:60},640:{slidesPerView:3,spaceBetween:80},768:{slidesPerView:4,spaceBetween:80},992:{slidesPerView:5,spaceBetween:90},1200:{slidesPerView:5,spaceBetween:100},}});window.addEventListener('load',()=>{AOS.init({duration:1000,easing:'ease-in-out',once:!0,mirror:!1})})})()